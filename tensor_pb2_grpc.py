...
class ExchangerStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.ExchangeTensor = channel.unary_unary(
                '/Exchanger/ExchangeTensor',
...
def add_ExchangerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ExchangeTensor': grpc.unary_unary_rpc_method_handler(
                    servicer.ExchangeTensor,
                    request_deserializer=tensor__pb2.Tensor.FromString,
                    response_serializer=tensor__pb2.Tensor.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'Exchanger', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('Exchanger', rpc_method_handlers)
